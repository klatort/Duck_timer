...
class GameManager:
    def __init__(self, hours, minutes, seconds, assets_path):
        ...
        estimated_bpm = future.result()
        self.renderer = Renderer(self.width, self.height, self.assets_path, estimated_bpm)
    ...
    def run_renderer(self):
        while self.running_event.is_set():
            self.renderer.render(self.ducks, self.time_left, self.show_fps, self.music)
